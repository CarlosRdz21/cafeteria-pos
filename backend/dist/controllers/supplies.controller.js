    ...
    static async update(req, res) {
        try {
            ...
            if (body.currentStock !== undefined)
                data.currentStock = toNumber(body.currentStock, existing.currentStock);
            if (body.unitCost !== undefined)
                data.unitCost = body.unitCost == null ? null : toNumber(body.unitCost, 0);
            if (body.minStock !== undefined)
                data.minStock = body.minStock == null ? null : toNumber(body.minStock, 0);
